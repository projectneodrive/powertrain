...
[ "_memory", "___indirect_function_table", "_serial_rx_buffer", "_serial_rx_capacity", "_serial_rx_commit", "_serial_status_buffer", "_serial_status_capacity", "_serial_status_commit", "_js_serial_connect", "_js_serial_disconnect", "_js_serial_write", "_jsHaveAsyncify", "_jsHaveJspi", "___asyncjs__qt_jspi_suspend_js", "_qt_jspi_resume_js", "_qt_jspi_can_resume_js", "_init_jspi_support_js", "_qt_asyncify_suspend_js", "_qt_asyncify_resume_js", "_main", "onRuntimeInitialized" ].forEach(prop => {
...
wasmBinaryFile = "serial_plotter_wasm.wasm";
   ...
   try {
    while (Module.NEO && Module.NEO.keepReading) {
     ...
     while (off < chunk.length) {
      ...
      HEAPU8.set(chunk.subarray(off, off + n), Module["_serial_rx_buffer"]() >>> 0);
...
function js_serial_disconnect() {
 ...
 (async function() {
  ...
  N.keepReading = false;
  try {
   if (N.reader) await N.reader.cancel();
  } catch (e) {}
  try {
   if (N.writer) N.writer.releaseLock();
  } catch (e) {}
  try {
   if (N.port) await N.port.close();
  } catch (e) {}
  Module.NEO = null;
...
function js_serial_write(text) {
 const N = Module.NEO;
 if (!N || !N.writer) return;
...
var wasmImports = {
 ...
 /** @export */ js_serial_connect: js_serial_connect,
 /** @export */ js_serial_disconnect: js_serial_disconnect,
 /** @export */ js_serial_write: js_serial_write,
...
var _serial_rx_buffer = Module["_serial_rx_buffer"] = createExportWrapper("serial_rx_buffer");

var _serial_rx_capacity = Module["_serial_rx_capacity"] = createExportWrapper("serial_rx_capacity");

var _serial_rx_commit = Module["_serial_rx_commit"] = createExportWrapper("serial_rx_commit");

var _serial_status_buffer = Module["_serial_status_buffer"] = createExportWrapper("serial_status_buffer");

var _serial_status_capacity = Module["_serial_status_capacity"] = createExportWrapper("serial_status_capacity");

var _serial_status_commit = Module["_serial_status_commit"] = createExportWrapper("serial_status_commit");
...
var ___start_em_js = Module["___start_em_js"] = 8878048;

var ___stop_em_js = Module["___stop_em_js"] = 8881265;
...
if (typeof exports === 'object' && typeof module === 'object')
  module.exports = serial_plotter_wasm_entry;
else if (typeof define === 'function' && define['amd'])
  define([], () => serial_plotter_wasm_entry);
